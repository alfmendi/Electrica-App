...
import { eliminarCliente } from "../../redux/clientesSlice";
...
// --------------------------------------------------
// --------------------------------------------------
// - Componente para eliminar un cliente de la BBDD -
// --------------------------------------------------
// --------------------------------------------------
const EliminarCliente = () => {
  ...
  // ----------------------------------------------
  // - Método para eliminar el cliente de la BBDD -
  // ----------------------------------------------
  const handleAceptar = async (e) => {
    ...
    try {
      // axiosPrivado es el hook no el módulo exportado de axiosAPI
      // useAxiosPrivado llama al módulo exportado de axiosAPI
      await axiosPrivado.delete(`/api/clientes/${clienteId}`);
      dispatch(eliminarCliente(clienteId));
      dispatch(setMensajeAMostrar("Cliente eliminado correctamente"));
      navigate("/clientes");
    } catch (error) {
