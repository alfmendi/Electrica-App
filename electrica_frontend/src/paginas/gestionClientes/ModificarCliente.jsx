...
import { modificarCliente } from "../../redux/clientesSlice";
...
// ---------------------------------------------------
// ---------------------------------------------------
// - Componente para modificar un cliente de la BBDD -
// ---------------------------------------------------
// ---------------------------------------------------
const ModificarCliente = () => {
  ...
  // -----------------------------------------------
  // - Método para modificar el cliente en la BBDD -
  // -----------------------------------------------
  const handleAceptar = async (e) => {
    ...
    try {
      ...
      dispatch(modificarCliente(respuesta.data));
      dispatch(setMensajeAMostrar("Cliente modificado correctamente"));
      navigate("/clientes");
    } catch (error) {
