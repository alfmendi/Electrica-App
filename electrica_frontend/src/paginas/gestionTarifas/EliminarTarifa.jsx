...
import { eliminarTarifa } from "../../redux/tarifasSlice";
...
// --------------------------------------------------
// --------------------------------------------------
// - Componente para eliminar una tarifa de la BBDD -
// --------------------------------------------------
// --------------------------------------------------
const EliminarTarifa = () => {
  ...
  // -----------------------------------------------
  // - UseEffect para obtener los datos a eliminar -
  // -----------------------------------------------
  useEffect(() => {
  ...
  // ---------------------------------------------
  // - Método para eliminar la tarifa en la BBDD -
  // ---------------------------------------------
  const handleAceptar = async (e) => {
    ...
    try {
      // axiosPrivado es el hook no el módulo exportado de axiosAPI
      // useAxiosPrivado llama al módulo exportado de axiosAPI
      await axiosPrivado.delete(`/api/tarifas/${tarifaId}`);
      dispatch(eliminarTarifa(tarifaId));
      dispatch(setMensajeAMostrar("Tarifa eliminada correctamente"));
      navigate("/tarifas");
    } catch (error) {
