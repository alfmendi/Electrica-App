...
// -------------------------------------------------------------------
// -------------------------------------------------------------------
// - Componente para modificar el password de un empleado en la BBDD -
// -------------------------------------------------------------------
// -------------------------------------------------------------------
  ...
  const handleAceptar = async (e) => {
    ...
    try {
      ...
      await axiosPrivado.patch(
        `/api/empleados/modificarPassword/${empleadoId}`,
        { password }
      );
      dispatch(setMensajeAMostrar("Password modificado correctamente"));
      navigate("/empleados");
    } catch (error) {
  ...
  return (
    <Contenedor>
      ...
      <Form onSubmit={handleAceptar}>
        <Titulo>Modificar Password</Titulo>
        ...
        <Linea>
          ...
          <Input
            ...
            placeholder={"Introduce el nuevo password..."}
            required
          />
        </Linea>
        <Linea>
          ...
          <Input
            ...
            placeholder={"Confirma el nuevo password..."}
            required
          />
        </Linea>
        <Linea>
