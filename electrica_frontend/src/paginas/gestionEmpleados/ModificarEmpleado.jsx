...
import { modificarEmpleado } from "../../redux/empleadosSlice";
...
// ----------------------------------------------------
// ----------------------------------------------------
// - Componente para modificar un empleado de la BBDD -
// ----------------------------------------------------
// ----------------------------------------------------
const ModificarEmpleado = () => {
  ...
  // -------------------------------------------------------------
  // - UseEffect para obtener los datos del empleado a modificar -
  // -------------------------------------------------------------
  useEffect(() => {
  ...
  // ------------------------------------------------
  // - Método para modificar el empleado en la BBDD -
  // ------------------------------------------------
  const handleAceptar = async (e) => {
    e.preventDefault();
    try {
      const empleadoModificar = { nombre, username, esAdmin };
      // axiosPrivado es el hook no el módulo exportado de axiosAPI
      // useAxiosPrivado llama al módulo exportado de axiosAPI
      ...
      dispatch(modificarEmpleado(respuesta.data));
      dispatch(setMensajeAMostrar("Empleado modificado correctamente"));
      navigate("/empleados");
    } catch (error) {
